  ...
  const items = [
    {
      id: 1,
      num: '01',
      title: 'Enterprise data platform for a company in financial industry',
    ...
    },
    {
      ...
      tag: 'Retail · ML/AI',
      year: '2024',
      blurb: 'Coordinated data scientists and store ops to deliver SKU-level forecasting — replacing a spreadsheet process used across 20+ stores.',
      stats: [{v: '20+', l: 'stores'}, {v: '8', l: 'specialists'}, {v: 'SKU', l: 'granularity'}],
